...
--
-- Host: localhost
-- Generation Time: Jan 27, 2015 at 02:18 PM
...
CREATE TABLE IF NOT EXISTS `attachments` (
  ...
  `attachment_model` enum('productcategory','product','admin','banklogo','post','system','other','file') CHARACTER SET utf8 COLLATE utf8_persian_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `files` (
  ...
  `file_status` enum('init','inprogress','ready','') NOT NULL,
  `date_modified` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
